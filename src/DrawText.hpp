...
inline DrawText::DrawText(void * font, int posX, int posY, char * str, GLfloat red, GLfloat green, GLfloat blue)
	: x(posX), y(posY), r(red), g(green), b(blue), string(str), font(font) {}
...
inline void DrawText::setFont(void * newFont) { font = newFont; }
...
inline void * DrawText::getFont() const { return font; }
